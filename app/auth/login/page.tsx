...
export default function LoginPage() {
  ...
  const [magicState, magicFormAction, magicPending] = useActionState(loginWithMagicLink, null)
  const [passState, passAction, passPending] = useActionState(login, null)
        ...
        <CardContent>
          <Tabs defaultValue="magiclink" className="w-full">
            ...
            <TabsContent value="magiclink">
              <form action={magicFormAction} className="space-y-4 pt-4">
                {magicState?.error && (
